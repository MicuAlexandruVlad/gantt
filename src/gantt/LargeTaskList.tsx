    ...
    return (
        <div className="w-full h-full flex flex-col overflow-hidden select-none">
            ...
            <div className="flex-1 overflow-auto">
                {/* Sticky header */}
                <div className="sticky min-w-fit shadow-md top-0 z-1 bg-[#f7f8fa] py-4 text-[#656771] grid grid-cols-[minmax(20px,20px)_minmax(200px,1fr)_minmax(120px,150px)_minmax(120px,150px)_minmax(100px,120px)_minmax(100px,150px)_minmax(100px,120px)_minmax(80px,120px)_minmax(120px,120px)_minmax(80px,120px)] gap-2 p-2">
